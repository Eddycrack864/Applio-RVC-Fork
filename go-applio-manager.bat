...
set "branch=main"
set "runtime=runtime"
set "repoUrl=https://github.com/bastianmarin/Applio-RVC-Fork/archive/refs/heads/%branch%.zip"
set "fixesFolder=Fixes"
set "localFixesPy=local_fixes.py"
set "principal=%cd%"
set "URL_BASE=https://huggingface.co/lj1995/VoiceConversionWebUI/resolve/main"
set "URL_EXTRA=https://huggingface.co/bastianmarin/applio/resolve/main"
